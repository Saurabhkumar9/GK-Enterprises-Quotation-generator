          ...
          <head>
            ...
            <style>
              * {
              ...
              .specification-item { margin-left: 16px; font-size: 11px; color: #4b5563; line-height: 1.4; }
              hr { border: none; border-top: 1px solid black; margin: 20px 0 10px; }
              img { max-width: 100%; height: auto; }
              .pdf-optimized { background: white; padding: 20px !important; }
              .pdf-optimized * { line-height: 1.3 !important; }
              @media print {
